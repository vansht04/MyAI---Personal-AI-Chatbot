...
export interface _SERVICE {
  ...
  'createConversation' : ActorMethod<[], ConversationId>,
  'deleteConversation' : ActorMethod<[ConversationId], boolean>,
  'getAnonymousMessageCount' : ActorMethod<[], bigint>,
  ...
  'sendMessage' : ActorMethod<[ConversationId, string], SendMessageResult>,
  'transform' : ActorMethod<[TransformationInput], TransformationOutput>,
  'updateConversationTitle' : ActorMethod<
